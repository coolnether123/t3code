...
const WINDOW_OPTIONS = [
  ...
  { value: 120, label: "120d", accessibilityLabel: "Past 120 days" },
  ...
  return (
    <View collapsable={false} className="flex-1 bg-sheet">
      ...
      >
        ...
        >
          <Text className="text-sm text-foreground underline">Codex usage &amp; resets</Text>
        </Pressable>
          ...
          <>
            ...
            {isPending ? (
              ...
              <>
                ...
                />
                <ProviderSection onShowResets={onShowResets} merged={merged} metric={metric} />
              ...
              <View className="flex-row items-center gap-2">
                ...
                {provider.provider === "codex" ? (
                  <Pressable
                    ...
                    onPress={props.onShowResets}
                    onLongPress={props.onShowResets}
                    delayLongPress={550}
                    className="min-h-11 justify-center"
                  >
