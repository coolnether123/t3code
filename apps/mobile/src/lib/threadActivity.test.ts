...
describe("buildThreadFeed", () => {
  it("projects Chrome screenshot metadata onto the expandable work row", () => {
    const threadId = ThreadId.make("screenshot-thread");
    const screenshot = {
      threadId,
      attachmentId: "screenshot-thread-12345678-1234-1234-1234-123456789abc",
    ...
    const thread = makeThread({
      ...
      activities: [
        makeActivity({
          id: EventId.make("chrome-screenshot"),
          kind: "tool.completed",
          ...
          payload: {
            ...
            data: {
              ...
              item: { tool: "computer_screenshot", result: { screenshot } },
            },
          },
        }),
      ],
    ...
    expect(group.activities[0]?.screenshot).toEqual(screenshot);
  });
