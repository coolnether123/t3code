...
/** Merge Codex's partial updates without allowing model-specific limits to replace Codex. */
...
/** Explain a limit stop from the snapshot observed by the time that event arrived. */
