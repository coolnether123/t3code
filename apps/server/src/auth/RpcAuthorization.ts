...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.serverRefreshUsageRates]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerConsumeResetCredit]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverGetResetCheck]: AuthOrchestrationReadScope,
  [WS_METHODS.serverStartResetCheck]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverCancelResetCheck]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverGetCommunityCheck]: AuthOrchestrationReadScope,
  [WS_METHODS.serverStartCommunityCheck]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverCancelCommunityCheck]: AuthOrchestrationOperateScope,
