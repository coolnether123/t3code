...
import { BrowserNotificationHost } from "./notifications/BrowserNotificationHost";
...
describe("AppRoot", () => {
  it("shares the application atom registry with routed UI and renderer-wide desktop hosts", () => {
    ...
    expect(isValidElement(children[1]) && children[1].type).toBe(BrowserNotificationHost);
