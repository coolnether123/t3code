...
export function RightPanelTabs(props: RightPanelTabsProps) {
  ...
  const onAddBrowserInProfile = props.onAddBrowserInProfile ?? props.onAddBrowser;
  ...
  const handleTabContextMenu = useCallback(
    async (event: ReactMouseEvent, surface: RightPanelSurface) => {
      ...
      const surfaceIndex = visibleSurfaces.findIndex((entry) => entry.id === surface.id);
      ...
      items.push(
        { id: "close", label: "Close" },
        {
          id: "close-others",
          label: "Close others",
          disabled: visibleSurfaces.length <= 1,
        },
        {
          id: "close-to-right",
          label: "Close to the right",
          disabled: surfaceIndex >= visibleSurfaces.length - 1,
        },
        {
          id: "close-all",
          label: "Close all",
          disabled: visibleSurfaces.length === 0,
        },
      );
      ...
      <div className="flex min-h-0 flex-1 flex-col" data-right-panel-surface-content>
        {visibleActiveSurfaceId === null ? (
          <RightPanelEmptyState
            ...
            onAddBrowserInProfile={onAddBrowserInProfile}
